...
fake_argv  = 'predict_clf_rf.launcher.py --db_host=192.168.1.83 '
fake_argv += '--symbol=EURUSD --interval=1 --shift=15 '
fake_argv += '--my_precision=my_precisionS,my_precisionB '

fake_argv = fake_argv.split()
#argv = fake_argv #### *!
#argv="python3 -u predict_clf_rf.py --db_host=192.168.1.83 --symbol=EURUSD --interval=1 --shift=15 --X_symbols=EURUSD,AUDUSD --X_include=rsi,* --X_exclude=volatility_kcli --tstamp=2022-08-10T00:00:00 --nrows=5000 --test_lenght=800 --nbins=24 --n_estimators=300 --bootstrap=True --class_weight=None".split()

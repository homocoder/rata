...
python -u rates_get_tstamp.py --db_host=192.168.1.83 --symbol=GBPUSD,USDJPY,USDCAD,AUDUSD,NZDUSD,USDCHF,EURUSD --kind=forex --interval=1 --tstamp_end=2022-09-04 --periods=30

...
python -u rates_get_tstamp.py --db_host=192.168.1.84 --symbol=GBPUSD,USDJPY,USDCAD,AUDUSD,NZDUSD,USDCHF,EURUSD --kind=forex --interval=1 --tstamp_end=2022-09-21 --periods=30

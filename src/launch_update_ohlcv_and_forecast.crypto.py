...
fake_argv = 'launch_update_ohlcv_and_forecast.py  --db_conf=conf/db.json --conf=conf/update_ohlcv_and_forecast.5.crypto.json '
...
for i in symbol_conf:
    ...
    cmd += 'python /home/selknam/dev/rata/src/update_ohlcv_and_forecast.py ' + symbol_params + ' --kind=crypto & \n'
print(cmd)
